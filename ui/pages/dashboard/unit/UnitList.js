...
// sections
import { UnitTableRow, UnitTableToolbar } from '../../../sections/@dashboard/unit-list';
...
// ----------------------------------------------------------------------
export default function UnitList({ unitList, isLoading, onDelete }) {
  const {
    dense,
    page,
    order,
  ...
  const handleEditRow = (id) => {
    navigate(PATH_DASHBOARD.unit.edit(id));
  };
