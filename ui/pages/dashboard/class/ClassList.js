...
// sections
import { ClassTableRow, ClassTableToolbar } from '../../../sections/@dashboard/class-list';
...
// ----------------------------------------------------------------------
export default function ClassList({ classList, isLoading, onDelete }) {
  const {
    dense,
    page,
    order,
  ...
  return (
    <Card>
      <ClassTableToolbar filterName={filterName} onFilterName={handleFilterName} />
